...
/***/ 11:
/*!**************************************!*\
  !*** D:/file/lolm/utils/ald-stat.js ***!
  \**************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

!function (t, n) { true ? module.exports = n() : undefined;}(this, function () {function t() {this.concurrency = 4, this.queue = [], this.tasks = [], this.activeCount = 0;var t = this;this.push = function (n) {this.tasks.push(new Promise(function (e, o) {var a = function a() {t.activeCount++, n().then(function (t) {e(t);}).then(function () {t.next();});};t.activeCount < t.concurrency ? a() : t.queue.push(a);}));}, this.all = function () {return Promise.all(this.tasks);}, this.next = function () {t.activeCount--, t.queue.length > 0 && t.queue.shift()();};}function n() {this.request = [], this.updata = !1, this.push = function (t) {this.request.length >= 8 && !this.updata && (this.updata = !0, e()), this.request.length >= 10 ? (this.request.shift(), this.request.push(t)) : this.request.push(t);}, this.concat = function () {this.request.map(function (t) {wx.Queue.push(t);}), this.request = [];};}function e() {"function" == typeof gt && "" === K && gt().then(function (t) {28 === t.length && (K = t, wx.setStorageSync("aldstat_op", t));});}function o(t) {this.app = t;}function a(t) {B = m(), V = t, ft = t.scene, this.aldstat = new o(this);}function r(t) {e();var n;n = t.scene != ft, ft = t.scene, z = 0, V = t, F = t.query.ald_share_src, X = t.query.aldsrc || "", Y = t.query.ald_share_src, ut || ht || wt || (W = !1), ut = !1, (0 !== Q && Date.now() - Q > 3e4 || n) && (ht || (T = m(), N = Date.now(), dt = 0)), 0 !== Q && Date.now() - Q < 3e4 && (at = !0), t.query.ald_share_src && "1044" == t.scene && t.shareTicket ? wx.getShareInfo({ shareTicket: t.shareTicket, success: function success(t) {tt = t, A("event", "ald_share_click", JSON.stringify(t));} }) : t.query.ald_share_src && A("event", "ald_share_click", 1), "" === nt && wx.getSetting({ withCredentials: !0, success: function success(t) {if (t.authSetting["scope.userInfo"]) {wx.getUserInfo({ withCredentials: !0, success: function success(t) {var n = v();nt = t, n.ufo = y(t), G = _(t.userInfo.avatarUrl.split("/")), g(n);} });}} }), D("app", "show");}function i() {e(), Q = Date.now(), "" === nt && wx.getSetting({ success: function success(t) {t.authSetting["scope.userInfo"] && wx.getUserInfo({ withCredentials: !0, success: function success(t) {nt = t, G = _(t.userInfo.avatarUrl.split("/"));var n = v();n.ufo = y(t), g(n);} });} }), D("app", "hide");}function s(t) {Z++, A("event", "ald_error_message", t);}function c(t) {st = t;}function u() {if (lt = Date.now(), rt = j ? this.$mp.page.route : this.route, q("page", "show"), at = !1, "" === K) {var _t = wx.getAccountInfoSync().miniProgram.appId;wx.login({ success: function success(n) {wx.request({ url: "https://adtest.xmadx.com/authorize/mini_program_openid", data: { ai: _t, uuid: $, jc: n.code, reqid: "1" }, success: function success(t) {t.data.code || (K = t.data.data.openid, wx.setStorageSync("aldstat_op", t.data.data.openid));} });}, fail: function fail(t) {} });}}function h() {it = rt, dt = Date.now() - lt;}function f() {it = rt, dt = Date.now() - lt;}function l() {A("event", "ald_pulldownrefresh", 1);}function d() {A("event", "ald_reachbottom", 1);}function p(t) {ht = !0;var n = S(t.path),e = {};for (var o in V.query) {"ald_share_src" !== o && "ald_share_op" !== o || (e[o] = V.query[o]);}var a = "";if (a = t.path.indexOf("?") == -1 ? t.path + "?" : t.path.substr(0, t.path.indexOf("?")) + "?", "" !== n) for (var o in n) {e[o] = n[o];}e.ald_share_src ? e.ald_share_src.indexOf($) == -1 && e.ald_share_src.length < 200 && (e.ald_share_src = e.ald_share_src + "," + $) : e.ald_share_src = $, C.useOpen && (e.ald_share_op ? e.ald_share_op.indexOf(K) == -1 && e.ald_share_op.length < 200 && (e.ald_share_op = e.ald_share_op + "," + K) : e.ald_share_op = K);for (var r in e) {r.indexOf("ald") == -1 && (a += r + "=" + e[r] + "&");}return t.path = a + (C.useOpen ? "ald_share_op=" + e.ald_share_op + "&" : "") + "ald_share_src=" + e.ald_share_src, A("event", "ald_share_status", t), t;}function w() {function t() {return Math.floor(65536 * (1 + Math.random())).toString(16).substring(1);}return t() + t() + t() + t() + t() + t() + t() + t();}function g(t) {function n() {return new Promise(function (n, e) {var o = { AldStat: "MiniApp-Stat", se: J || "", op: K || "", img: G };"" === E || (o.ai = E), wx.request({ url: "https://" + b + ".aldwx.com/d.html", data: t, header: o, method: "GET", success: function success(t) {n(200 == t.statusCode ? "" : "status error");}, fail: function fail() {n("fail");} });});}z++, t.at = T, t.uu = $, t.v = H, t.ak = C.app_key.replace(/(\t)|(\s)/g, ""), t.wsr = V, t.ifo = W, t.rq_c = z, t.ls = B, t.te = U, t.et = Date.now(), t.st = Date.now(), C.useOpen, wx.Queue.push(n);}function v() {var t = {};for (var n in et) {t[n] = et[n];}return t;}function _(t) {for (var n = "", e = 0; e < t.length; e++) {t[e].length > n.length && (n = t[e]);}return n;}function m() {return "" + Date.now() + Math.floor(1e7 * Math.random());}function y(t) {var n = {};for (var e in t) {"rawData" != e && "errMsg" != e && (n[e] = t[e]);}return n;}function S(t) {if (t.indexOf("?") == -1) return "";var n = {};return t.split("?")[1].split("&").forEach(function (t) {var e = t.split("=")[1];n[t.split("=")[0]] = e;}), n;}function x(t) {for (var n in t) {if ("object" == typeof t[n] && null !== t[n]) return !0;}return !1;}function D(t, n) {var e = v();e.ev = t, e.life = n, e.ec = Z, e.dr = Date.now() - N, "show" == n && (e.uo = C.useOpen), X && (e.qr = X, e.sr = X), F && (e.usr = F), g(e);}function q(t, n) {var e = v();e.ev = t, e.life = n, e.pp = rt, e.pc = it, e.dr = Date.now() - N, (ht || wt) && (e.so = 1), wt = !1, ht = !1, st && "{}" != JSON.stringify(st) && (e.ag = st), X && (e.qr = X, e.sr = X), F && (e.usr = F), at && (e.ps = 1), ot ? e.pdr = dt : (ct = rt, ot = !0, e.ifp = ot, e.fp = rt, e.pdr = 0), g(e);}function A(t, n, e) {var o = v();o.ev = t, o.tp = n, o.dr = Date.now() - N, e && (o.ct = e), g(o);}function I(t, n, e) {if (t[n]) {var o = t[n];t[n] = function (t) {e.call(this, t, n), o.call(this, t);};} else t[n] = function (t) {e.call(this, t, n);};}function O(t) {var n = {};for (var e in t) {"onLaunch" !== e && "onShow" !== e && "onHide" !== e && "onError" !== e && (n[e] = t[e]);}return n.onLaunch = function (n) {a.call(this, n), "function" == typeof t.onLaunch && t.onLaunch.call(this, n);}, n.onShow = function (n) {r.call(this, n), t.onShow && "function" == typeof t.onShow && t.onShow.call(this, n);}, n.onHide = function () {i.call(this), t.onHide && "function" == typeof t.onHide && t.onHide.call(this);}, n.onError = function (n) {s.call(this, n), t.onError && "function" == typeof t.onError && t.onError.call(this, n);}, n;}function M(t) {var n = {};for (var e in t) {"onLoad" !== e && "onShow" !== e && "onHide" !== e && "onUnload" !== e && "onPullDownRefresh" !== e && "onReachBottom" !== e && "onShareAppMessage" !== e && (n[e] = t[e]);}return n.onLoad = function (n) {c.call(this, n), "function" == typeof t.onLoad && t.onLoad.call(this, n);}, n.onShow = function (n) {u.call(this), "function" == typeof t.onShow && t.onShow.call(this, n);}, n.onHide = function (n) {h.call(this), "function" == typeof t.onHide && t.onHide.call(this, n);}, n.onUnload = function (n) {f.call(this), "function" == typeof t.onUnload && t.onUnload.call(this, n);}, n.onReachBottom = function (n) {d(), t.onReachBottom && "function" == typeof t.onReachBottom && t.onReachBottom.call(this, n);}, n.onPullDownRefresh = function (n) {l(), t.onPullDownRefresh && "function" == typeof t.onPullDownRefresh && t.onPullDownRefresh.call(this, n);}, t.onShareAppMessage && "function" == typeof t.onShareAppMessage && (n.onShareAppMessage = function (n) {var e = t.onShareAppMessage.call(this, n);return void 0 === e ? (e = {}, e.path = this.route) : void 0 === e.path && (e.path = this.route), p.call(this, e);}), n;}function P(t) {return App(O(t));}function k(t) {return Page(M(t));}function L(t) {return j = !0, O(t);}function R(t) {return M(t);}var C = __webpack_require__(/*! ./ald-stat-conf */ 12);void 0 === wx.Queue && (wx.Queue = new t(), wx.Queue.all()), "" === C.app_key && console.error("请在ald-stat-conf.js文件中填写小程序统计/广告监测平台创建小程序后生成的app_key，请参考接入文档 http://doc.aldwx.com 小程序统计平台-快速接入指南！"), C.useOpen && console.warn("提示：开启了useOpen配置后，如果不上传用户OpendID则不会上报数据，上传方式：http://doc.aldwx.com 小程序统计/广告监测平台-快速接入指南-上传OpenID！");var H = "7.3.7",b = "log",U = "wx",E = function () {return void 0 === wx.getAccountInfoSync ? "" : wx.getAccountInfoSync().miniProgram.appId.split("").map(function (t) {return t.charCodeAt(0) + 9;}).join("-");}(),j = !1,T = m(),B = "",N = Date.now(),Q = 0,J = "",K = function () {var t = "";try {t = wx.getStorageSync("aldstat_op");} catch (t) {}return t;}(),G = "",z = 0,V = "",W = "",$ = function () {var t = "";try {t = wx.getStorageSync("aldstat_uuid");} catch (n) {t = "uuid_getstoragesync";}if (t) W = !1;else {t = w();try {wx.setStorageSync("aldstat_uuid", t), W = !0;} catch (t) {wx.setStorageSync("aldstat_uuid", "uuid_getstoragesync");}}return t;}(),F = "",X = "",Y = "",Z = 0,tt = "",nt = "",et = {},ot = !1,at = !1,rt = "",it = "",st = "",ct = "",ut = !0,ht = !1,ft = "",lt = (new n(), 0),dt = 0,pt = [{ name: "scanCode" }, { name: "chooseAddress" }, { name: "chooseImage" }, { name: "previewImage" }, { name: "chooseInvoiceTitle" }, { name: "chooseInvoice" }],wt = !1;!function () {pt.forEach(function (t) {t.fn = wx[t.name];var n = t.name;Object.defineProperty(wx, n, { get: function get() {return wt = !0, t.fn;} });});}();var gt = "";!function () {wx.request({ url: "https://" + b + ".aldwx.com/config/app.json", header: { AldStat: "MiniApp-Stat" }, method: "GET", success: function success(t) {200 === t.statusCode && (H < t.data.version && console.warn("您的SDK不是最新版本，部分功能不可用，请尽快前往 http://tj.aldwx.com/downSDK 升级"), t.data.warn && console.warn(t.data.warn), t.data.error && console.error(t.data.error));} });}(), wx.aldstat = new o("");try {var vt = wx.getSystemInfoSync();et.br = vt.brand, et.pm = vt.model, et.pr = vt.pixelRatio, et.ww = vt.windowWidth, et.wh = vt.windowHeight, et.lang = vt.language, et.wv = vt.version, et.wvv = vt.platform, et.wsdk = vt.SDKVersion, et.sv = vt.system;} catch (t) {}wx.getNetworkType({ success: function success(t) {et.nt = t.networkType;} }), wx.getSetting({ success: function success(t) {t.authSetting["scope.userLocation"] ? wx.getLocation({ type: "wgs84", success: function success(t) {et.lat = t.latitude, et.lng = t.longitude, et.spd = t.speed;} }) : C.getLocation && wx.getLocation({ type: "wgs84", success: function success(t) {et.lat = t.latitude, et.lng = t.longitude, et.spd = t.speed;} });} }), o.prototype.sendEvent = function (t, n) {if ("" !== t && "string" == typeof t && t.length <= 255) {if ("string" == typeof n && n.length <= 255) A("event", t, n);else if ("object" == typeof n) {if (JSON.stringify(n).length >= 255) return void console.error("自定义事件参数不能超过255个字符，请参考接入文档 http://doc.aldwx.com 小程序统计平台-快速接入指南-自定义事件！");if (x(n)) return void console.error("事件参数内部只支持Number、String等类型，请参考接入文档 http://doc.aldwx.com 小程序统计平台-快速接入指南-自定义事件！");for (var e in n) {"number" == typeof n[e] && (n[e] = n[e] + "s##");}A("event", t, JSON.stringify(n));} else void 0 === n ? A("event", t, !1) : console.error("事件参数必须为String、Object类型，且参数长度不能超过255个字符，请参考接入文档 http://doc.aldwx.com 小程序统计平台-快速接入指南-自定义事件！");} else console.error("事件名称必须为String类型且不能超过255个字符，请参考接入文档 http://doc.aldwx.com 小程序统计平台-快速接入指南-自定义事件！");}, o.prototype.sendSession = function (t) {if ("" === t || !t) return void console.error("请传入从后台获取的session_key");J = t;var n = v();n.tp = "session", n.ct = "session", n.ev = "event", "" === nt ? wx.getSetting({ success: function success(t) {t.authSetting["scope.userInfo"] ? wx.getUserInfo({ success: function success(t) {n.ufo = y(t), G = _(t.userInfo.avatarUrl.split("/")), "" !== tt && (n.gid = tt), g(n);} }) : "" !== tt && (n.gid = tt, g(n));} }) : (n.ufo = nt, "" !== tt && (n.gid = tt), g(n));}, o.prototype.sendOpenid = function (t) {if ("" === t || !t || 28 !== t.length) return void console.error("OpenID不符合规则，请参考接入文档 http://doc.aldwx.com 小程序统计/广告监测平台-快速接入指南！");K = t, wx.setStorageSync("aldstat_op", t);var n = v();n.tp = "openid", n.ev = "event", n.ct = "openid", g(n);}, o.prototype.setOpenid = function (t) {"function" == typeof t && (gt = t, e());};return C.plugin ? { App: P, Page: k, MpvueApp: L, MpvuePage: R } : function (t) {!function () {var t = App,n = Page,e = Component;App = function App(n) {I(n, "onLaunch", a), I(n, "onShow", r), I(n, "onHide", i), I(n, "onError", s), t(n);}, Page = function Page(t) {var e = t.onShareAppMessage;I(t, "onLoad", c), I(t, "onUnload", f), I(t, "onShow", u), I(t, "onHide", h), I(t, "onReachBottom", d), I(t, "onPullDownRefresh", l), void 0 !== e && null !== e && (t.onShareAppMessage = function (t) {if (void 0 !== e) {var n = e.call(this, t);return void 0 === n ? (n = {}, n.path = rt) : void 0 === n.path && (n.path = rt), p(n);}}), n(t);}, Component = function Component(t) {try {var n = t.methods.onShareAppMessage;I(t.methods, "onLoad", c), I(t.methods, "onUnload", f), I(t.methods, "onShow", u), I(t.methods, "onHide", h), I(t.methods, "onReachBottom", d), I(t.methods, "onPullDownRefresh", l), void 0 !== n && null !== n && (t.methods.onShareAppMessage = function (t) {if (void 0 !== n) {var e = n.call(this, t);return void 0 === e ? (e = {}, e.path = rt) : void 0 === e.path && (e.path = rt), p(e);}}), e(t);} catch (n) {e(t);}};}();}();});

/***/ }),

/***/ 12:
/*!*******************************************!*\
  !*** D:/file/lolm/utils/ald-stat-conf.js ***!
  \*******************************************/
/*! no static exports found */
...
exports.app_key = "320c95a6058e9749ed0c55c90fd750f7 "; // 在此处填写小程序统计/广告监测平台创建小程序后生成的app_key。必填项
...
/***/ 130:
/*!***************************************************************!*\
  !*** D:/file/lolm/components/jyf-parser/libs/MpHtmlParser.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
 ...
 * @listens MIT
 */
var cfg = __webpack_require__(/*! ./config.js */ 131),
blankChar = cfg.blankChar,
CssHandler = __webpack_require__(/*! ./CssHandler.js */ 132),
...
/***/ 131:
/*!*********************************************************!*\
  !*** D:/file/lolm/components/jyf-parser/libs/config.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 132:
/*!*************************************************************!*\
  !*** D:/file/lolm/components/jyf-parser/libs/CssHandler.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
